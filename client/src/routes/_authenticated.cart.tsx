...
export const Route = createFileRoute("/_authenticated/cart")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Review your Meridian order before checkout." },
      { property: "og:title", content: "Your cart — Meridian" },
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {removalTarget?.food.name} will be taken out of your cart. You can add it
              again from the menu at any time.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
