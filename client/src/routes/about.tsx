  ...
  head: () => ({
    meta: [
      { title: "Our story — Meridian Kitchen & Bar" },
      {
        name: "description",
        content:
          "How Meridian began: one wood-fired oven, three local farms and a refusal to compromise between dining in and ordering out.",
      },
      { property: "og:title", content: "Our story — Meridian Kitchen & Bar" },
      {
        property: "og:description",
        content: "One wood-fired oven, three local farms, one standard.",
      },
    ],
  }),
  component: AboutPage,
      ...
      <section className="container-page grid gap-12 py-16 lg:grid-cols-2 lg:items-center">
        ...
        <Reveal delay={0.08} className="min-w-0">
          ...
          <div className="mt-6 space-y-4 text-base leading-relaxed text-muted-foreground">
            <p>
              Our founders met working opposite ends of the same pass — one on grill, one on
              pastry. They wanted a restaurant without theatre: excellent produce, a short
              menu, and prices that let people come back on a Tuesday.
            </p>
            <p>
              The first Meridian had twelve seats and a queue down the block. When delivery
              became half our covers, we rebuilt the kitchen around it instead of treating it
              as an afterthought — separate pass, insulated packing, tighter zones.
            </p>
            <p>
              Today one kitchen serves both rooms: the dining room on Meridian Row and every
              address within fifteen minutes of it.
            </p>
          </div>
        </Reveal>
      </section>
        ...
        <div className="container-page grid gap-10 md:grid-cols-2 md:items-center">
          ...
          <Reveal delay={0.08}>
            ...
            <p className="mt-4 max-w-md text-base leading-relaxed text-muted-foreground">
              The menu changes with the season, but the signature burger isn't going
              anywhere. Order it while it's still warm from the grill.
            </p>
