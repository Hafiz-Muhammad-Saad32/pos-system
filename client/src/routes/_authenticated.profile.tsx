...
export const Route = createFileRoute("/_authenticated/profile")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Manage your Meridian account details and delivery address." },
      { property: "og:title", content: "Profile — Meridian" },
      { property: "og:description", content: "Manage your account and delivery address." },
    ],
  }),
      ...
      <div className="container-page grid gap-6 py-12 lg:grid-cols-2">
            ...
            {[
              ...
              <div key={field.id}>
                ...
                <Input
                  ...
                  onChange={(event) =>
                    setPersonal({ ...personal, [field.id]: event.target.value })
                  }
                  className="mt-2 h-11"
                />
              </div>
            ...
            {[
              ...
              <div key={field.id}>
                ...
                <Input
                  ...
                  onChange={(event) =>
                    setAddress({ ...address, [field.id]: event.target.value })
                  }
                  className="mt-2 h-11"
                />
              </div>
        ...
        <section className="rounded-2xl border border-border bg-card p-6">
          ...
          <div className="mt-5 space-y-5">
            ...
            <Button variant="outline" className="h-11 w-full rounded-full" onClick={onChangePassword}>
              Update password
            </Button>
          </div>
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  Your cart is kept on this device, but you'll need to sign in again to check
                  out or track orders.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
