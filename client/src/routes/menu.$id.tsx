  ...
  head: () => ({
    meta: [
      { title: "Dish details — Meridian Kitchen & Bar" },
      {
        name: "description",
        content:
          "Full details for this Meridian dish: ingredients, price, rating, availability and related plates from the same section of the menu.",
      },
      { property: "og:title", content: "Dish details — Meridian" },
      {
        property: "og:description",
        content: "Ingredients, price, rating and availability for this Meridian dish.",
      },
    ],
  }),
...
function FoodDetailPage() {
  ...
  const food = useQuery({ queryKey: ["food", id], queryFn: () => getFoodById(id), retry: false });
    ...
    <>
      ...
      <article className="container-page grid gap-12 py-10 lg:grid-cols-2 lg:py-16">
        ...
        <div className="min-w-0">
          ...
          <p className="mt-8 font-display text-4xl text-foreground">
          ...
          {!item.available ? (
            <div className="mt-8 rounded-xl border border-destructive/30 bg-destructive/5 p-5 text-sm text-muted-foreground">
              ...
              <p className="mt-2">
                The kitchen has run out of a key ingredient today, so ordering is disabled.
                Save it to your favourites and we'll keep it handy for your next order.
              </p>
            </div>
          ) : null}
