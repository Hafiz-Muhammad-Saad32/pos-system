...
export const Route = createFileRoute("/_authenticated/orders/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Track active Meridian orders and revisit past ones." },
      { property: "og:title", content: "My orders — Meridian" },
      { property: "og:description", content: "Track active orders and revisit past ones." },
    ],
  }),
