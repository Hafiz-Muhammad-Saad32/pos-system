  ...
  head: () => ({
    meta: [
      { title: "Contact — Meridian Kitchen & Bar" },
      {
        name: "description",
        content:
          "Reach the Meridian team: phone, email, address, opening hours and a direct message form for bookings and events.",
      },
      { property: "og:title", content: "Contact — Meridian Kitchen & Bar" },
      {
        property: "og:description",
        content: "Phone, email, address, opening hours and a direct message form.",
      },
    ],
  }),
