...
export const Route = createFileRoute("/login")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Sign in to your Meridian account to order, track deliveries and manage favourites.",
      },
      { property: "og:title", content: "Log in — Meridian" },
      { property: "og:description", content: "Sign in to order and track deliveries." },
    ],
  }),
  component: LoginPage,
});
