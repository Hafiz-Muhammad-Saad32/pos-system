  ...
  return (
    <>
      <PageMeta
        ...
        description="Confirm your details and place your Meridian order."
        ogDescription="Confirm your details and place your order."
      />
      <PageHeader
      ...
      <form
        className="container-page grid gap-10 py-12 lg:grid-cols-[1.3fr_1fr]"
        onSubmit={placeOrder}
        noValidate
      >
              ...
              {cart.lines.map((line) => (
                <li key={line.food.id} className="flex items-center gap-3">
                  ...
                  <span className="min-w-0 flex-1">
                    <span className="block truncate text-sm text-foreground">{line.food.name}</span>
