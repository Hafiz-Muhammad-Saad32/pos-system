  ...
  return (
    <div className="container-page py-12">
      <PageMeta
        ...
        description="Follow your Meridian order from the pass to your door."
        ogDescription="Follow your order from the pass to your door."
      />
      <Link
        to="/orders"
      ...
      <div className="mt-10 grid gap-10 lg:grid-cols-[1fr_1.1fr]">
        ...
        <div className="space-y-6">
          ...
          <section className="grid gap-6 rounded-2xl border border-border bg-card p-6 sm:grid-cols-2">
            ...
            <div>
              <h3 className="text-sm uppercase tracking-[0.16em] text-muted-foreground">Payment</h3>
