...
export const Route = createFileRoute("/dashboard")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Live service overview: today's orders, revenue, prep queue and menu availability.",
      },
      { property: "og:title", content: "Dashboard — Meridian POS" },
      {
        property: "og:description",
        content: "Live service overview for the Meridian restaurant operations console.",
      },
    ],
  }),
  component: () => (
